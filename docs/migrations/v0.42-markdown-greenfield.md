# Migrating your OpenClaw brain to gbrain v0.41 (greenfield)

The v0.41 lens packs ship a one-shot importer that re-ingests your
existing your OpenClaw brain (`~/git/brain/atoms/`, `concepts/`, `ideas/`)
...
1. **Upgrade gbrain to v0.41+:**
   ```bash
   gbrain upgrade
   gbrain --version  # should be 0.41.0 or later
   ```
...
The your OpenClaw skills themselves shrink to thin wrappers:
